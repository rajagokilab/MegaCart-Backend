...
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER','rajagokilavivek@gmail.com')
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD','eaaw smdg xdtz gnhv')
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', f"MegaCart Support <{EMAIL_HOST_USER}>")
